              ...
              <Tooltip.Provider key={i}>
                <Tooltip.Root>
                  <Tooltip.Trigger asChild>
                    <div className="group relative h-36 w-36 overflow-hidden bg-[#09c558]/30 transition-all duration-300 hover:-rotate-45 hover:scale-110 hover:rounded-lg md:h-40 md:w-40 border-3 border-[#09c558]">
                      <Image
                        src={img.src}
                        alt={img.title}
                        fill
