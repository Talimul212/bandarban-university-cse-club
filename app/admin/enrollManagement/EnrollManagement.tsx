...
export default function EnrollManagement({
  ...
  return (
    <div className="min-h-screen bg-green-50/50 font-sans">
      {/* Page Header */}
      <div className="bg-linear-to-br from-green-800 to-green-600 px-8 py-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-1">
            <GraduationCap size={28} className="text-green-200" />
            <h1 className="text-2xl font-bold text-white tracking-tight">
              BU CSE Club
            </h1>
          </div>
          <p className="text-green-200 text-sm pl-10">
            ...
            <table className="w-full text-left">
              <thead>
                {table.getHeaderGroups().map((headerGroup) => (
                  <tr key={headerGroup.id} className="bg-green-50/70">
